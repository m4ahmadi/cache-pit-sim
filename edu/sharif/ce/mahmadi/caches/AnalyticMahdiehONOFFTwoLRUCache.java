...
public class AnalyticMahdiehONOFFTwoLRUCache extends AnalyticCache {

    private final int cacheLimit;
    private AnalyticMahdiehONOFFLRUCache virtualCache;
    private double CTime;
    private double T_ON_;
    private double T_OFF_;

    public AnalyticMahdiehONOFFTwoLRUCache(int id, double downloadRate, Simulation simulation, Dist mpopularityDist, int mcacheSize, double onMean, int offMean) {
        super(id, downloadRate, simulation, mpopularityDist);
        this.cacheLimit = mcacheSize;
        CTime = -1;
        T_ON_ = onMean;
        T_OFF_ = T_ON_ * offMean;
        virtualCache = new AnalyticMahdiehONOFFLRUCache(id, 0.0, simulation, mpopularityDist, mcacheSize, onMean, offMean);
