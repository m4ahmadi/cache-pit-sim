...
public class AnalyticMultiClassMahdiehONOFFLRUCache extends AnalyticCache {
    ...
    public AnalyticMultiClassMahdiehONOFFLRUCache(int id, double downloadRate, Simulation simulation, Dist mpopularityDist, int mcacheSize) {
