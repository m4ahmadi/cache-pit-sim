...
public class BasicCacheNetworkSimulation extends Simulation {
    ...
    private void generateServers() {
        ...
        switch (policy) {
            ...
            case LRUMultiClassONOFFMahdieh:
                //remember to replace the ananlytic file inside this class with multiclass version
            ...
            case TwoLRUMultiClassONOFFMahdieh:
                //remeber to replace the ananlytic file inside this class with multiclass version
    ...
    public static void RUN(String simulationType) {
        ...
        else if (simulationType.equals("8")) cacheSizeEtaLifetimeMultiExecution(); //Fig. 8
        else if (simulationType.equals("7")) rateLifetimeMultiExecution(); //Fig. 7
        else if (simulationType.equals("10")) downloadAnalyticTraceMultiExecution(); //Fig. 10
        else if (simulationType.equals("12"))
            cacheSizeAnalyticTraceMultiExecution(); //verify the analytic value for different cache sizes
        else if (simulationType.equals("9")) traceTrimMultiExecution(); //Fig. 9
        else if (simulationType.equals("11")) traceStatistcis(); //print trace statistics for other parts basically producing file vm.txt
    ...
    private static void downloadMultiExecution() {
        ...
        //double[] downloadRates = {1.0 / 0.05 , 1.0 / 0.1 , 1.0 / 0.15, 1.0 / 0.2, 1.0 / 0.25, 1.0 / 0.3}; //Fig. 3
        //double[] downloadRates = {0.0, 1.0 / 3600.0, 1.0 / 7200.0, 1.0/14400.0, 1.0/21600.0,  1.0/28800.0, 1.0/36000.0}; //fig. 9
        double[] downloadRates = {1.0 / 0.1};
    ...
    private static void rateLifetimeMultiExecution() {
        ...
        double[] density = {1.0, 2.0, 4.0, 8.0, 10, 1e2, 1e3, 1e4, 1e5, 1e6, 1e7};
        //double[] density = {0.2, 0.4,0.8};
